INSERT INTO commande (idCommande, idUser, totalprd, totalqte)
SELECT
  a.*
FROM
  JSON_TABLE(
    ...
    '$[*]'
    COLUMNS (
      idCommande INT PATH '$.id',
      idUser INT PATH '$.userId',
      totalprd INT PATH '$.totalProducts',
      totalqte INT PATH '$.totalQuantity'
    )
  ) a;
